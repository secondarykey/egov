    ...
    >
      ...
      <Box sx={{
        ...
        <Stack direction="row" sx={{ alignItems: 'anchor-center', mt: 1 }} spacing={1}>
          ...
          <IconButton onClick={handleMuteToggle} sx={{ color: muted ? 'rgba(255,255,255,0.3)' : 'white', width: 28, height: 28, ml: 1.5 }}>
          ...
          <Slider
            ...
            sx={{
              color: muted ? 'rgba(255,255,255,0.3)' : 'white', width: 160, py: '10px', mr: 1.5,
